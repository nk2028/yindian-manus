...
export const translations: Record<Language, Translations> = {
  'zh_HK': {
    ...
    about: {
      ...
      history: '此後，由眾多專家聯手，不斷收集整理大量漢字讀音資料，製作了漢字音典 APP。nk2028 基於漢字音典 APP 發佈了音典網頁版，讓更多使用者能夠方便地查詢漢字在不同時代、不同地區的讀音。目前音典網頁版收錄了約 2400 種語言變體，涵蓋上古音、中古音、近代音及現代各地方言。',
      features: '主要功能',
  ...
  'zh_CN': {
    ...
    about: {
      ...
      history: '此后，由众多专家联手，不断收集整理大量汉字读音资料，制作了汉字音典 APP。nk2028 基于汉字音典 APP 发布了音典网页版，让更多使用者能够方便地查询汉字在不同时代、不同地区的读音。目前音典网页版收录了约 2400 种语言变体，涵盖上古音、中古音、近代音及现代各地方言。',
      features: '主要功能',
