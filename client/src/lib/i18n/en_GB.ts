...
export const en_GB: Translations = {
  ...
  about: {
    ...
    relatedWeiEr: 'Web version by WeiEr: Provides character pronunciation query, text annotation, language map, settings, and more',
    relatedBuJi: 'Dialect Atlas by BuJi: Provides Middle Chinese query, phoneme query, tone query, character query, regional mapping, custom mapping, and more',
